...
import com.lewa.filemanager.FileManagerMainActivity;
...
public class FileInfoUtil {
    ...
    public static void openFile(String filePath, Context context) {
        ...
        /* if the file type is Directory,Open it
         *
         * add 2013-03-26
         */
        if (aFile.isDirectory()) {
            OpenSearchDir(context, aFile);
            return;
        }
     ...
     * add 2013-03-26
     */
    public static void OpenSearchDir(Context search, File ofile) {
        Intent intent = new Intent(search,
                FileManagerMainActivity.class);
        //intent.putExtra("isNew", true);
        intent.putExtra("searchpath", ofile.getPath());
