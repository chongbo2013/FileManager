...
public class VideoDB {
     ...
     *
     * @param key      key in searching video files
            ...
            do {
                ...
                if (loadThumb == true)    //create new item with thumbnail
                {
                    if (title.toLowerCase().contains(key.toLowerCase()) || text.toLowerCase().contains(key.toLowerCase())) {
                        normalItem = new VideoFileInfo(title, text, thumbnail, filePath, Constants.CLASS_VIDEO);
                ...
                {
                    if (title.toLowerCase().contains(key.toLowerCase()) || text.toLowerCase().contains(key.toLowerCase())) {
                        normalItem = new VideoFileInfo(title, text, null, filePath, Constants.CLASS_VIDEO);
