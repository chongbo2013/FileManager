...
import com.lewa.search.util.MimeUtil;
...
public class MimeTypeMap {
    ...
    public Map<String, String> getExtensionToMimeTypeMap(String filterKey) {
        if (filterKey == null) {
            return mExtensionToMimeTypeMap;
        } else {
            return MimeUtil.filterMapByKey(mExtensionToMimeTypeMap, filterKey);
        }
    }
...
//            sMimeTypeMap.loadEntry("application/oda", "oda");
            ...
            sMimeTypeMap.loadEntry("application/ogg", "oga");
...
//                    "otg");
//            sMimeTypeMap.loadEntry("application/vnd.oasis.opendocument.image",
//                    "odi");
//            sMimeTypeMap.loadEntry(
...
//                    "ots");
//            sMimeTypeMap.loadEntry("application/vnd.oasis.opendocument.text",
//                    "odt");
//            sMimeTypeMap.loadEntry(
...
//            sMimeTypeMap.loadEntry("application/vnd.stardivision.impress",
//                    "sdd");
//            sMimeTypeMap.loadEntry("application/vnd.stardivision.impress",
//                    "sdp");
...
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.calc.template",
//                    "stc");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.draw", "sxd");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.draw.template",
//                    "std");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.impress", "sxi");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.impress.template",
//                    "sti");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.math", "sxm");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.writer", "sxw");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.writer.global",
//                    "sxg");
//            sMimeTypeMap.loadEntry("application/vnd.sun.xml.writer.template",
//                    "stw");
...
//            sMimeTypeMap.loadEntry("application/xhtml+xml", "xhtml");
            ...
            sMimeTypeMap.loadEntry("audio/amr-wb", "amb");
...
//            sMimeTypeMap.loadEntry("text/plain", "po"); // reserve "pot" for
//            // vnd.ms-powerpoint
