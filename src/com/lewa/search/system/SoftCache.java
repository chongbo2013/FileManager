...
public class SoftCache {
    ...
    //add 2013-03-26
    public static Drawable directoryThumb;
    ...
    public static Drawable otherThumb;
...
//		numberMapContract = ContractDB.getContractMapPhone();
    ...
    private static void loadThumbs(Context context) {
        ...
        musicThumb = res.getDrawable(R.drawable.fic_music);
        imageThumb = res.getDrawable(R.drawable.fic_picture);
        videoThumb = res.getDrawable(R.drawable.fic_video);
        apkThumb = res.getDrawable(R.drawable.fic_apk);
        themeThumb = res.getDrawable(R.drawable.fic_theme);
        docThumb = res.getDrawable(R.drawable.fic_doc);
        directoryThumb = res.getDrawable(R.drawable.infoic_folder);
        otherThumb = res.getDrawable(R.drawable.fic_other);
