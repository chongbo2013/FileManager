...
/**
 * This class defines a view class for music infomation.
 *
 * @author wangfan
 * @version 2012.07.04
 */

public class MusicFileInfo extends FileInfo {
    ...
    public MusicFileInfo(String title, String text, Drawable thumbnail, String filePath,
                         int fileType) {
